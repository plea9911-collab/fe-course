...
alter table order_item
	add constraint fk_product_pid foreign key(pid)
...
-- 'OR0001' 형식으로 아이디 생성, LPAD(값, 크기, 채워지는 문자형식) : OR0002
...
-- 'M0001' 형식으로 아이디 생성, LPAD(값, 크기, 채워지는 문자형식) : P0001
