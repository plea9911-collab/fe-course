/**
 * wrapper 클래스 - 기본현(원시) 데이터 타입을 객체로 생성하기 위하는 클래스 타입
 * -기본형(원시) 데이터 타입의 클래스는 첫글자를 대문자로 정의한 Pascal Case(첫글자 대문자)
...
let num1 = 100; //기본형 선형 및 할당
let num2 = new Number(100); //참조형 선언 및
