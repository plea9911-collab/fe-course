...
console.log(str2.concat(', React Programming!!')); //+를 가독성을 위해 concat로 대체


let str3 = '          Hello~ React Programming!!        '
console.log(str3.length);
console.log(str3.trim(), str3.trim.length); //공백 삭제
console.log(str3.trimEnd(), str3.trimEnd().length); //뒷 공백만 삭제
...
// console.log(str4.substring(start, end));
console.log(str4.slice(0, 5)); //0~4번지까지 출력
