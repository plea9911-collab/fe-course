...
class Student {
    ...
    // getName= () => this.#name; 실행문이 하나이기 때문에 이것도 가능
    getAge = () => { return this.#age; }
    getAddress = () => { return this.#address; }
    getEmoji = () => { return this.emoji; }

    setName = (name) => {return this.#name = name;}
    // setName = (name) => this.#name = name; 이것도 가능
    setAge = (age) => {return this.#age = age;}
    setAddress = (address) => {return this.#address = address;}
    setEmoji = (emoji) => {return this.emoji = emoji;}
...
//3. dataList 배열 객체를 이용하여 학생 객체 생성 후 
//      학생리스트(배열)에 저장
const studentList = [];
