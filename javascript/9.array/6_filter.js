...
//4자 이상인 이름만 필터링
let filterObj = strList.filter((str) => str.length >= 4); //['hong', ..전체 리턴]
...
console.log();
console.log(lemons); //배열 나옴
console.log(lemonsFind); //첫번째 레몬만 호출됨
console.log(lemonsFind.name, lemonsFind.emoji); //객체로 결과 나옴
console.log(lemons[0].name, lemons[0].emoji);  //배열에서 추림
